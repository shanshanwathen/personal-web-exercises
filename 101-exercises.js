...
function quotient(numberOne, numberTwo) {
...
function sumOfSquares(numberOne, numberTwo) {
  return add(square(numberOne), square(numberTwo));
}
...
function areaOfRectangle(numberOne, numberTwo) {
...
function endsWithVowel(string) {
  return isVowel(string.charAt(string.length - 1));
}
