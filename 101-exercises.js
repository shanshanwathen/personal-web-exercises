...
function isPositiveOdd(number){
  if(isPositive(number) === true && isOdd(number) === true){
    return true;
  }else{
    return false;
  }
...
function isPositiveEven(number){
  if(isPositive(number) === true && isEven(number) === true){
    return true;
  }else{
    return false;
  }
...
function isNegativeOdd(number){
  if(isNegative(number) === true && isOdd(number) === true){
    return true;
  }else{
    return false;
  }
...
function isNegativeEven(number){
  if(isNegative(number) === true && isEven(number) === true){
    return true;
  }else{
    return false;
  }
...
function isMultipleOfBothThreeAndFive(number){
  if(isMultipleOfThree(number) === true && isMultipleOfFive(number) === true){
    return true;
  }else{
    return false;
  }
...
function firstAndLast(sequence){
  ...
  newArray[0] = sequence[0];
  newArray[1] = sequence[sequence.length - 1];
  return newArray;
}
...
function elementsTimesTwo(array) {
  var multipliedByTwo = [];
  for (var i = 0; i < array.length; i++) {
    multipliedByTwo.push(array[i] * 2);
  }
...
function numberOfItemTypes(input) {
  var number = 1;
  for (var i = 1; i < input.items.length; i++) {
    if (input.items[i] === input.items[0]) {
      continue;
    }
    number = number + 1;
  }
...
function totalNumberOfItems(input) {
  ...
  for (var i = 0; i < input.items.length; i++) {
    total = total + input.items[i].quantity;
  }
  return total;
}
